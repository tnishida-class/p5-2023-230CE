function setup() {
    ...
    for(i=0;i<scores.length; i++){
      ...
      fill("black");
      //ellipse(((i*w+2)+(w-4))-width/scores.length/2, height-h ,10);
      //let j = i+1
      //const h2 = height*scores[j]/100;
      //line(((i*w+2)+(w-4))-width/scores.length/2, height-h, ((j*w+2)+(w-4))-width/scores.length/2, height-h2);
    }
